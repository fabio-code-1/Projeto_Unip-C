...
void Cadastro_Cliente()
{
    ...
    FILE *Cliente = fopen("Clientes.txt", "a");
    if(Cliente == NULL)
    {
        printf("ERRO! o arquivo não foi criado");
    }
...
void Relatorio()
{
    ...
    FILE *Relatoriotxt = fopen("Relatorio.txt", "a");
...
void Menu_Colsutar_Cadastros()
{
    ...
    FILE *Funcionarios = fopen("Funcionarios.txt", "rt");
    if(Funcionarios == NULL)
    {
        printf("ERRO! o arquivo não foi criado");
    }
    ...
    //arq.txt Clientes
    FILE *Cliente = fopen("Clientes.txt", "rt");
    if(Cliente == NULL)
    {
        printf("ERRO! o arquivo não foi criado");
    }
...
Consultar_Relatorio()
{
    ...
    //arq.txt Relatorio
    FILE *Relatoriotxt = fopen("Relatorio.txt", "rt");
    if(Relatoriotxt == NULL)
    {
        printf("ERRO! o arquivo não foi criado");
    }
